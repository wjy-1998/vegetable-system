...
<body>
	<?php
		$area = $_POST["area"];
		$landid = $_POST["landid"];
		$cropt = $_POST["croptype"];
		echo "<input type='text' value='$area' id='area'>";
		echo "<input type='text' value='$landid' id='landid'>";
		echo "<input type='text' value='$area$landid' id='arealand'>";
		echo "<input type='text' value='$cropt' id='cropt'>";
	?>
	...
	<div class="container">
		...
		<!-- 内容区域 -->
		<form action="function/resetregion_block.php" method="post">
						...
						<div class="box_content_con_right">
							<ul>
								<li onclick="onBtn(this)">
									<a href="#">阳江市A01</a>
									<a href="#">叶菜类</a>
									<button class="leafbgcolor" value="A01">A01</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市A02</a>
									<a href="#">叶菜类</a>
									<button class="leafbgcolor" value="A02">A02</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市A03</a>
									<a href="#">叶菜类</a>
									<button class="leafbgcolor" value="A03">A03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市A04</a>
									<a href="#">根茎类</a>
									<button class="rootbgcolor" value="A04">A04</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市A05</a>
									<a href="#">瓜类</a>
									<button class="melon" value="A05">A05</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市B01</a>
									<a href="#">无作物</a>
									<button class="nocrop" value="B01">B01</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市B02</a>
									<a href="#">无作物</a>
									<button class="nocrop" value="B02">B02</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市B03</a>
									<a href="#">叶菜类</a>
									<button class="leafbgcolor" value="B03">B03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市B04</a>
									<a href="#">根茎类</a>
									<button class="rootbgcolor" value="B04">B04</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市B05</a>
									<a href="#">豆类</a>
									<button class="peas" value="B05">B05</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市C01</a>
									<a href="#">瓜类</a>
									<button class="melon" value="C01">C01</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市C02</a>
									<a href="#">瓜类</a>
									<button class="melon" value="C02">C02</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市C03</a>
									<a href="#">根茎类</a>
									<button class="rootbgcolor" value="C03">C03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市C04</a>
									<a href="#">叶菜类</a>
									<button class="leafbgcolor" value="C04">C04</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市C05</a>
									<a href="#">豆类</a>
									<button class="peas" value="C05">C05</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市D01</a>
									<a href="#">无作物</a>
									<button class="nocrop" value="D01">D01</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市D02</a>
									<a href="#">根茎类</a>
									<button class="rootbgcolor" value="D02">D02</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市D03</a>
									<a href="#">瓜类</a>
									<button class="melon" value="D03">D03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市D04</a>
									<a href="#">葱蒜类</a>
									<button class="onion" value="D04">D04</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市D05</a>
									<a href="#">叶菜类</a>
									<button class="leafbgcolor" value="D05">D05</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市E01</a>
									<a href="#">叶菜类</a>
									<button class="leafbgcolor" value="E01">E01</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市E02</a>
									<a href="#">无作物</a>
									<button class="nocrop" value="E02">E02</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市E03</a>
									<a href="#">瓜类</a>
									<button class="melon" value="E03">E03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市E04</a>
									<a href="#">葱蒜类</a>
									<button class="onion" value="E04">E04</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">阳江市E05</a>
									<a href="#">葱蒜类</a>
									<button class="onion" value="E05">E05</button>
								</li>
							</ul>
						</div>
						...
						<div class="box_content_con_right">
							<ul>
								<li onclick="onBtn(this)">
									<a href="#">潮州市A01</a>
									<a href="#">豆类</a>
									<button class="peas" value="A01">A01</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市A02</a>
									<a href="#">叶菜类</a>
								...
								<li onclick="onBtn(this)">
									<a href="#">潮州市A03</a>
									<a href="#">瓜类</a>
									<button class="melon" value="A03">A03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市A04</a>
									<a href="#">瓜类</a>
									<button class="melon" value="A04">A04</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市A05</a>
									<a href="#">瓜类</a>
								...
								<li onclick="onBtn(this)">
									<a href="#">潮州市B01</a>
									<a href="#">豆类</a>
									<button class="peas" value="B01">B01</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市B02</a>
									<a href="#">无作物</a>
								...
								<li onclick="onBtn(this)">
									<a href="#">潮州市B05</a>
									<a href="#">瓜类</a>
									<button class="melon" value="B05">B05</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市C01</a>
									<a href="#">豆类</a>
									<button class="peas" value="C01">C01</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市C02</a>							
									<a href="#">豆类</a>
									<button class="peas" value="C02">C02</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市C03</a>
									<a href="#">豆类</a>
									<button class="peas" value="C03">C03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市C04</a>
									<a href="#">叶菜类</a>
								...
								<li onclick="onBtn(this)">
									<a href="#">潮州市C05</a>
									<a href="#">瓜类</a>
									<button class="melon" value="C05">C05</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市D01</a>
									<a href="#">无作物</a>
								...
								<li onclick="onBtn(this)">
									<a href="#">潮州市D03</a>
									<a href="#">豆类</a>
									<button class="peas" value="D03">D03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市D04</a>
									<a href="#">葱蒜类</a>
								...
								<li onclick="onBtn(this)">
									<a href="#">潮州市E02</a>
									<a href="#">根茎类</a>
									<button class="rootbgcolor" value="E02">E02</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市E03</a>
									<a href="#">豆类</a>
									<button class="peas" value="E03">E03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市E04</a>
									<a href="#">根茎类</a>
									<button class="rootbgcolor" value="E04">E04</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">潮州市E05</a>
									<a href="#">葱蒜类</a>
						...
						<div class="box_content_con_right">
							<ul>
								<li onclick="onBtn(this)">
									<a href="#">清远市A01</a>
									<a href="#">无作物</a>
									<button class="nocrop" value="A01">A01</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市A02</a>
									<a href="#">葱蒜类</a>
									<button class="onion" value="A02">A02</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市A03</a>
									<a href="#">葱蒜类</a>
									<button class="onion" value="A03">A03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市A04</a>
									<a href="#">瓜类</a>
								...
								<li onclick="onBtn(this)">
									<a href="#">清远市B03</a>
									<a href="#">葱蒜类</a>
									<button class="onion" value="B03">B03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市B04</a>
									<a href="#">葱蒜类</a>
									<button class="onion" value="B04">B04</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市B05</a>
									<a href="#">豆类</a>
								...
								<li onclick="onBtn(this)">
									<a href="#">清远市C02</a>
									<a href="#">叶菜类</a>
									<button class="leafbgcolor" value="C02">C02</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市C03</a>
									<a href="#">叶菜类</a>
									<button class="leafbgcolor" value="C03">C03</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市C04</a>
									<a href="#">葱蒜类</a>
									<button class="onion" value="C04">C04</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市C05</a>
									<a href="#">葱蒜类</a>
									<button class="onion" value="C05">C05</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市D01</a>
									<a href="#">叶菜类</a>
									<button class="leafbgcolor" value="D01">D01</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市D02</a>
									<a href="#">叶菜类</a>
									<button class="leafbgcolor" value="D02">D02</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市D013</a>
									<a href="#">豆类</a>
								...
								<li onclick="onBtn(this)">
									<a href="#">清远市D04</a>
									<a href="#">无作物</a>
									<button class="nocrop" value="D04">D04</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市D05</a>
									<a href="#">葱蒜类</a>
									<button class="onion" value="D05">D05</button>
								</li>
								<li onclick="onBtn(this)">
									<a href="#">清远市E01</a>
									<a href="#">叶菜类</a>
								...
								<li onclick="onBtn(this)">
									<a href="#">清远市E05</a>
									<a href="#">无作物</a>
									<button class="nocrop" value="E05">E05</button>
								</li>
							</ul>
						</div>
	...
	<script src="js/resetregion.js"></script>
</body>
</html>