...
<head>
	<meta charset="UTF-8">
	<title>施肥记录</title>
	<link rel="stylesheet" type="text/css" href="css/fertilize.css">
	...
	<div class="container">
		...
		<div class="context">
			<div class="context_top">
				<a href="function/add_feritilize.php">添加记录</a>
			</div>
			<div class="context_box">
				...
				<ul>
					<?php
						...
						$sql = "select * from function_management where farm_operation='施肥';";
